...
const variants = {
  primary: "bg-purple-600 text-white border-2 border-purple-600 hover:bg-purple-700 hover:border-purple-700",
  secondary: "bg-yellow-400 text-black border-2 border-yellow-400 hover:bg-yellow-500 hover:border-yellow-500",
